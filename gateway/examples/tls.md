...
через ALPN. Gateway принимает только защищённые конфигурации TLS.
...
и при подключении с `Host: shop.localhost` gateway выбирает соответствующий
сертификат и server-блок.
