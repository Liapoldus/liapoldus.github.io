...
только один раз. Команда разрешена, когда в БД нет ни одного действующего,
неотозванного и неистёкшего ключа; проверка условия и вставка verifier
выполняются атомарно в SQLite. Просроченные и отозванные записи сохраняются для
аудита и не блокируют локальное восстановление доступа. До создания хотя бы
